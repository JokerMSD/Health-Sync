  ...
  return (
    <>
      ...
      <section className={Style.loginSectionBackground}>
        <div className={`${Style.loginSection} ${darkMode ? Style["dark-mode"] : ''}`}>
          <div className={`${Style.formDiv} ${darkMode ? Style["dark-mode"] : ''}`}>
            <img className={Style.girlImg} src={Girl} />
            <div className={Style.loginFormContainer}>
              <LoginForm />
            </div>
            <div className={`${Style.registerSection} ${darkMode ? Style["dark-mode"] : ''}`}>
              <p className={`${Style.registerLabel} ${darkMode ? Style["dark-mode"] : ''}`}>Ainda não tem uma conta?</p>
              <button className={`${Style.registerBtn} ${darkMode ? Style["dark-mode"] : ''}`}>Cadastre-se</button>
            </div>
          </div>
